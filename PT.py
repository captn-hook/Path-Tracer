        ...
        with open(datafilename) as csv_file:
            ...
            for row in csv_reader:
                if line_count == 0:
                    ...
                    print("TRAMDAMNFD", row[1::])
                    transmissionTransposer.append(row[1::])

                line_count += 1

            transmissionTransposer = transpose(transmissionTransposer, transmission)

            for row in transmissionTransposer:
                for i in row:
